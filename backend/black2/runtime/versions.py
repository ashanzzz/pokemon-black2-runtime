...
RUNTIME_RELEASE_VERSION = "13.0.0"
WORLD3D_SCENE_VERSION = "13.0.0"
ORIGINAL_MAP_UI_VERSION = "13.0.0"
...
PROTOCOL_VERSIONS: tuple[dict[str, str], ...] = (
    ...
    {"id": "matrix_global_navigation", "name": "Matrix Global Navigation", "version": "black2-matrix-global-navigation/v1"},
