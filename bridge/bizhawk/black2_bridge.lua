...
local emu_dir = (os.getenv and os.getenv("BLACK2_BIZHAWK_DIR")) or ""
if emu_dir ~= "" then
    package.cpath = package.cpath .. ";" .. emu_dir .. "/Lua/?.dll;" .. emu_dir .. "/Lua/socket/?.dll"
end
package.cpath = package.cpath .. ";./Lua/?.dll;./Lua/socket/?.dll;?.dll"
...
local function get_rom_info()
    local managed_rom_path = (os.getenv and os.getenv("BLACK2_ROM_PATH")) or nil
    return {
        ...
        rom_path = managed_rom_path,
        rom_path_source = managed_rom_path and "launcher_env" or "unresolved"
    }
end
